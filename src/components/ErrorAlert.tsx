    ...
    <>
      ...
      >
        <div className="w-full flex flex-col items-center space-y-4 sm:items-end">
          ...
          >
            <div
              className="max-w-sm w-full bg-red-100 shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden">
              <div className="p-4">
